...
class ControlAsistenciasController extends Controller
{
    ...
    //         // Preparar datos para Excel - HOJA 1: ASISTENCIAS REGISTRADAS
    ...
    //         // Preparar datos para Excel - HOJA 2: SIN ASISTENCIA
    ...
    //         return Excel::download(new ReporteCompletoAsistenciasExport($excelDataCompleto), $fileName);
    //     } catch (\Exception $e) {
    //         return response()->json([
    //             'status' => 'error',
